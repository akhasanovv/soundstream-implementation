...
class STFTDiscriminator(nn.Module):
    ...
    def __init__(self, in_channels=32, n_fft=1024, hop_length=256):
        ...
        self.blocks = nn.ModuleList([
            STFTResidualUnit(in_channels=in_channels, out_channels=2*in_channels, stride=(1, 2)),
            STFTResidualUnit(in_channels=2*in_channels, out_channels=4*in_channels, stride=(2, 2)),
            STFTResidualUnit(in_channels=4*in_channels, out_channels=4*in_channels, stride=(1, 2)),
            STFTResidualUnit(in_channels=4*in_channels, out_channels=8*in_channels, stride=(2, 2)),
            STFTResidualUnit(in_channels=8*in_channels, out_channels=8*in_channels, stride=(1, 2)),
            STFTResidualUnit(in_channels=8*in_channels, out_channels=16*in_channels, stride=(2, 2))
        ])
